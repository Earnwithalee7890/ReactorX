...
export default function FaucetSwapTab() {
    ...
    return (
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
            ...
            {/* ─── COLORFUL PROMO SECTION ─── */}
            <div style={{
                marginTop: 32, borderRadius: 24, overflow: "hidden",
                background: "linear-gradient(135deg, #1e1b4b, #312e81, #3730a3, #1e3a5f)",
                ...
                <div style={{ padding: "36px 32px", position: "relative", zIndex: 1 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
                        <div style={{
                            ...
                            display: "flex", alignItems: "center", justifyContent: "center",
                            fontSize: 24, boxShadow: "0 4px 16px rgba(251,191,36,0.3)"
                        }}>⚡</div>
                        <div>
                            <h3 style={{ fontSize: 20, fontWeight: 900, color: "#fff", margin: 0, letterSpacing: "-0.02em" }}>
                                Powered by Somnia Reactivity
                            </h3>
                            <p style={{ fontSize: 12, color: "rgba(255,255,255,0.5)", margin: 0, fontWeight: 500 }}>
                                The first DeFi protocol with autonomous on-chain liquidations
                            </p>
                        </div>
                    </div>
                    ...
                    <div style={{
                        ...
                        {[
                            { icon: "🔮", label: "Native Reactivity", desc: "No bots, no keepers", color: "#a78bfa" },
                            { icon: "🛡️", label: "Auto Liquidations", desc: "Instant risk protection", color: "#f87171" },
                            { icon: "💎", label: "Multi-Collateral", desc: "STT, USDC, USDT, WETH", color: "#34d399" },
                            { icon: "🚀", label: "Sub-second Finality", desc: "400K+ TPS on Somnia", color: "#fbbf24" },
                        ].map(feat => (
                            <div key={feat.label} style={{
                                ...
                                <div>
                                    <div style={{ fontSize: 13, fontWeight: 800, color: feat.color }}>{feat.label}</div>
                                    <div style={{ fontSize: 11, color: "rgba(255,255,255,0.4)", marginTop: 2 }}>{feat.desc}</div>
                                </div>
                            </div>
                        ))}
                    </div>
